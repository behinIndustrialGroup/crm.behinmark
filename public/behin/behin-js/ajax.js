...
function open_admin_modal_with_data(data, title = '', customFun = null) {
    html = '<div class="modal fade" id="admin-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">' +
        '<div class="modal-dialog modal-lg">' +
        '<div class="modal-content">';
    if (title) {
        html += '<div class="modal-header" id="modal-header">' + title + '</div>';
    }
